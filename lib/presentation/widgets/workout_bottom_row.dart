...
class WorkoutBottomRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<TrainingPlanModel>(
      builder: (context, trainingData, child){return Row(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            if (trainingData.blockIndex >= 0 &&
                trainingData.blockIndex < sessionList[trainingData.sessionIndex].list.length - 1) {
